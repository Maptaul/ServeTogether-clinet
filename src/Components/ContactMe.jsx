...
const ContactMe = () => {
  ...
  return (
    <>
      <section className="bg-base-200 rounded-md mx-auto text-white py-12 px-6">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-8">
          {/* lottie Section */}
          <div className="w-full md:w-1/2 flex rounded-md justify-center">
            <Lottie animationData={lotteContact}> </Lottie>
          </div>
          {/* Form Section */}
